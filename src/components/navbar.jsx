    ...
    <div className="w-[100vw] flex flex-col lg:items-center">
      ...
      >
        <div className="flex justify-center">
          <a href="https://www.instagram.com/ogunzshotit" target="_Blank">
            <svg
              width="20px"
              viewBox="0 0 20 20"
              version="1.1"
          ...
          <a
            href="https://twitter.com/ogunzshotit"
            target="_Blank"
            className="mx-[0.5rem]"
          >
            <svg
        ...
        <p className="text-[1.5rem] font-semibold">ogunzshotit</p>
        ...
        <div className="hidden lg:flex lg:mr-[1rem]">
          ...
          >
            <p className="text-[1.5vw] headingfont font-bold">Home</p>
          </Link>
          <Link
            to="/About"
            className="nav"
          ...
          >
            <p className="text-[1.5vw] headingfont font-bold mx-[1rem]">About</p>
          </Link>
          <Link
            to="/Events"
            className="nav"
          ...
          >
            <p className="text-[1.5vw] headingfont font-bold">Events</p>
          </Link>
          <Link
            to="/Potraits"
            className="nav"
          ...
          >
            <p className="text-[1.5vw] headingfont font-bold mx-[1rem]">
              Potraits
            </p>
          </Link>
          <Link
          ...
          >
            <p className="text-[1.5vw] headingfont font-bold">Contact</p>
          </Link>
        </div>
